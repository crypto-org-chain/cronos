...
var ICACallbackMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"seq\",\"type\":\"uint64\"},{\"internalType\":\"bool\",\"name\":\"ack\",\"type\":\"bool\"},{\"internalType\":\"string\",\"name\":\"packetSrcChannel\",\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"packetDstChannel\",\"type\":\"string\"}],\"name\":\"onPacketResultCallback\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"payable\",\"type\":\"function\"}]",
}
...
// OnPacketResultCallback is a paid mutator transaction binding the contract method 0x45eb23e3.
//
// Solidity: function onPacketResultCallback(uint64 seq, bool ack, string packetSrcChannel, string packetDstChannel) payable returns(bool)
func (_ICACallback *ICACallbackTransactor) OnPacketResultCallback(opts *bind.TransactOpts, seq uint64, ack bool, packetSrcChannel string, packetDstChannel string) (*types.Transaction, error) {
	return _ICACallback.contract.Transact(opts, "onPacketResultCallback", seq, ack, packetSrcChannel, packetDstChannel)
}

// OnPacketResultCallback is a paid mutator transaction binding the contract method 0x45eb23e3.
//
// Solidity: function onPacketResultCallback(uint64 seq, bool ack, string packetSrcChannel, string packetDstChannel) payable returns(bool)
func (_ICACallback *ICACallbackSession) OnPacketResultCallback(seq uint64, ack bool, packetSrcChannel string, packetDstChannel string) (*types.Transaction, error) {
	return _ICACallback.Contract.OnPacketResultCallback(&_ICACallback.TransactOpts, seq, ack, packetSrcChannel, packetDstChannel)
}

// OnPacketResultCallback is a paid mutator transaction binding the contract method 0x45eb23e3.
//
// Solidity: function onPacketResultCallback(uint64 seq, bool ack, string packetSrcChannel, string packetDstChannel) payable returns(bool)
func (_ICACallback *ICACallbackTransactorSession) OnPacketResultCallback(seq uint64, ack bool, packetSrcChannel string, packetDstChannel string) (*types.Transaction, error) {
	return _ICACallback.Contract.OnPacketResultCallback(&_ICACallback.TransactOpts, seq, ack, packetSrcChannel, packetDstChannel)
}
