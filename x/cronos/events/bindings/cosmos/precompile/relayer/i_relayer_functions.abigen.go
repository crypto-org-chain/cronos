...
// RegisterCounterpartyPayee is a paid mutator transaction binding the contract method 0x5d3db16c.
//
// Solidity: function registerCounterpartyPayee(string portID, string channelID, address relayerAddr) payable returns(bool)
func (_RelayerFunctions *RelayerFunctionsTransactor) RegisterCounterpartyPayee(opts *bind.TransactOpts, portID string, channelID string, relayerAddr common.Address) (*types.Transaction, error) {
	return _RelayerFunctions.contract.Transact(opts, "registerCounterpartyPayee", portID, channelID, relayerAddr)
}

// RegisterCounterpartyPayee is a paid mutator transaction binding the contract method 0x5d3db16c.
//
// Solidity: function registerCounterpartyPayee(string portID, string channelID, address relayerAddr) payable returns(bool)
func (_RelayerFunctions *RelayerFunctionsSession) RegisterCounterpartyPayee(portID string, channelID string, relayerAddr common.Address) (*types.Transaction, error) {
	return _RelayerFunctions.Contract.RegisterCounterpartyPayee(&_RelayerFunctions.TransactOpts, portID, channelID, relayerAddr)
}

// RegisterCounterpartyPayee is a paid mutator transaction binding the contract method 0x5d3db16c.
//
// Solidity: function registerCounterpartyPayee(string portID, string channelID, address relayerAddr) payable returns(bool)
func (_RelayerFunctions *RelayerFunctionsTransactorSession) RegisterCounterpartyPayee(portID string, channelID string, relayerAddr common.Address) (*types.Transaction, error) {
	return _RelayerFunctions.Contract.RegisterCounterpartyPayee(&_RelayerFunctions.TransactOpts, portID, channelID, relayerAddr)
}

// RegisterPayee is a paid mutator transaction binding the contract method 0xb0dff939.
//
// Solidity: function registerPayee(string portID, string channelID, address relayerAddr) payable returns(bool)
func (_RelayerFunctions *RelayerFunctionsTransactor) RegisterPayee(opts *bind.TransactOpts, portID string, channelID string, relayerAddr common.Address) (*types.Transaction, error) {
	return _RelayerFunctions.contract.Transact(opts, "registerPayee", portID, channelID, relayerAddr)
}

// RegisterPayee is a paid mutator transaction binding the contract method 0xb0dff939.
//
// Solidity: function registerPayee(string portID, string channelID, address relayerAddr) payable returns(bool)
func (_RelayerFunctions *RelayerFunctionsSession) RegisterPayee(portID string, channelID string, relayerAddr common.Address) (*types.Transaction, error) {
	return _RelayerFunctions.Contract.RegisterPayee(&_RelayerFunctions.TransactOpts, portID, channelID, relayerAddr)
}

// RegisterPayee is a paid mutator transaction binding the contract method 0xb0dff939.
//
// Solidity: function registerPayee(string portID, string channelID, address relayerAddr) payable returns(bool)
func (_RelayerFunctions *RelayerFunctionsTransactorSession) RegisterPayee(portID string, channelID string, relayerAddr common.Address) (*types.Transaction, error) {
	return _RelayerFunctions.Contract.RegisterPayee(&_RelayerFunctions.TransactOpts, portID, channelID, relayerAddr)
}
