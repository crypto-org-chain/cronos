...
func NewSimApp(logger log.Logger, db dbm.DB, baseAppOptions ...func(*baseapp.BaseApp)) (*App, error) {
	...
	app := New(logger, db, nil, false, map[int64]bool{}, DefaultNodeHome, simcli.FlagPeriodValue, encodingConfig, EmptyAppOptions{}, []string{}, baseAppOptions...)
...
func TestAppImportExport(t *testing.T) {
	...
	newDB, newDir, logger, skip, err := simtestutil.SetupSimulation(config, "leveldb-app-sim-2", "Simulation-2", simcli.FlagVerboseValue, simcli.FlagEnabledValue)
	require.NoError(t, err, "simulation setup failed")
