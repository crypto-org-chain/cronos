...
* 2026-04-29: enforce create-only mapping for already-mapped denoms and tighten source-denom validation boundaries
...
The following guardrails are now enforced in keeper/middleware implementation:
