...
// PatchCmd constructs the "patch" subcommand for the database command group.
// The returned *cobra.Command is configured to perform database patching of specific block heights;
// it is named "patch" and is not marked as deprecated.
