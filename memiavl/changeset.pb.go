...
type WALEntry struct {
	...
	// the commit of the first version might set an initial_version,
	// the other version must not change initial_version.
	InitialVersion int64 `protobuf:"varint,3,opt,name=initial_version,json=initialVersion,proto3" json:"initial_version,omitempty"`
}
...
func (m *WALEntry) GetInitialVersion() int64 {
	if m != nil {
...
func (*MultiTreeMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_54242fa334002fa1, []int{3}
}
...
var fileDescriptor_54242fa334002fa1 = []byte{
	...
	,
}
...
func (m *WALEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.InitialVersion != 0 {
		i = encodeVarintChangeset(dAtA, i, uint64(m.InitialVersion))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Upgrades) > 0 {
...
func (m *WALEntry) Size() (n int) {
	...
	if m.InitialVersion != 0 {
		n += 1 + sovChangeset(uint64(m.InitialVersion))
	}
	return n
}
