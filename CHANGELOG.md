...
* [#2030](https://github.com/crypto-org-chain/cronos/pull/2030) fix(cronos)!: prevent silent fund loss on CRC21 conversion to invalid targets (zero address, precompile range, EOAs); bank-level blocking of 0x00..0xff is gated behind the `v1.8` upgrade handler for coordinated activation.
