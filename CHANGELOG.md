...
* [#2044](https://github.com/crypto-org-chain/cronos/pull/2044) chore(ci): add dependabot grouping config; harden dependabot-update-all (pull_request_target, head.sha, grouped-title tolerance); scope dependency review to go diffs.
