...
- [#571](https://github.com/crypto-org-chain/cronos/pull/571) Support export/import patched result, much faster to import the results than replay the tx.
- [#577](https://github.com/crypto-org-chain/cronos/pull/577) Skip patch tnx exist with success status.
...
- (rpc) [cronos#373](https://github.com/crypto-org-chain/cronos/pull/373) Fix websocket push duplicated messages to client.
