...
* [#2176](https://github.com/crypto-org-chain/cronos/pull/2176) fix(mempool): clear ante cache entries on eviction and bound its size independently of the mempool.
