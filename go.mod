...
replace (
	...
	// TODO: remove emporary fix for client state query issue v10.5.0-cronos
	...
	github.com/evmos/ethermint => github.com/crypto-org-chain/ethermint v0.22.1-0.20260420091208-c05ed0bf5c85
