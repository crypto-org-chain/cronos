...
// release/v0.50.x
replace (
	cosmossdk.io/store => github.com/mmsqe/cosmos-sdk/store v0.0.0-20241217065901-b1b4efd7d9dd
	cosmossdk.io/x/tx => github.com/mmsqe/cosmos-sdk/x/tx v0.0.0-20241217065901-b1b4efd7d9dd
	github.com/cosmos/cosmos-sdk => github.com/mmsqe/cosmos-sdk v0.46.0-beta2.0.20241217065901-b1b4efd7d9dd
)
