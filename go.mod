...
replace (
	...
	// ethermint #1016: appmempool.Inserter + InserterProvider for EVM direct-insert (PR head).
	github.com/evmos/ethermint => github.com/crypto-org-chain/ethermint v0.22.1-0.20260626190409-1389b15f5e35
