...
replace (
	...
	// ethermint #1016: appmempool.MempoolClient + InsertTx for EVM direct-insert (PR head).
	github.com/evmos/ethermint => github.com/crypto-org-chain/ethermint v0.22.1-0.20260702163919-6f932cde4455
